...
class edd_calc():
    ...
    def set_callbacks(self):
        #set call back for entered text and calc button
        self.text_box['validatecommand'] = self.store_date
        self.calc_button['command'] = self.calculate_EDD
        
    def store_date(self):
        self.date = self.text_box.get()
        print(self.date)
